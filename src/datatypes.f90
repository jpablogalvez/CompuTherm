...
!
       type thermo
         ...
         real(kind=8)                               ::  Gtherm   !  Thermal Gibbs free energy
         ...
         real(kind=8)                               ::  Etherm   !  Thermal internal energy
         ...
         real(kind=8)                               ::  Htherm   !  Thermal enthalpy
         ...
         real(kind=8)                               ::  Stherm   !  Total entropy
